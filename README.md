...
| 팀원     | 이메일 | 전화번호 | 역할 |
|:---------:|:----------:|:----------:|:----------:|
| 황반콰  | hoangkhoa21913388@gmail.com | 010 - 2388 - 1398 | 웹사이트 및 PPT 정리 |
| 황티타오 | hoangthao21921541@gmail.com | 010 - 5788 -1398 | 웹사이트 |
 ...
 * OPEN API 활용하여 한국에서 유기동물 현황을 분석한다. 과정은 다음으로 참고하면 한다.
 2022년 8월에만 총 약 1만 유기동물을 접수했다. 이렇게 큰 숫자를 보니까 심각한 환황을 보인다. 평균 하루에 약 300건을 접수하고 그 중 주로 "개"와 "고양이"를 발견했다.
...
<left><img width="300" height="200" src="https://cdn.mground.kr/mground/2021/11/%EC%95%88%EB%9D%BD%EC%82%AC%EC%9C%84%EA%B8%B0-%EC%9C%A0%EA%B8%B0%EA%B2%AC-%EC%9E%85%EC%96%91.jpg"><left>
<img width="300" height="200" src="https://image.kmib.co.kr/online_image/2020/0729/611718110014851798_1.jpg" />
<img width="300" height="200" src="https://img.animalplanet.co.kr/thumbnail/2020/07/23/2000/8s6nt1hl1016wh1l06br.jpg" />
...
filter를 이용하여 원하는 대로 데이터를 선정한다.
   ...
   * 째, 발견 도시를 알아보도록 `noticeno` field에서 `noticeCity` (인천, 서울,...)를 생성한다.
...
<p align="center">
 ...
 <p align="center">     
  <em>그림 6: 품종별 접수건 및 일별 품종별 접수건 </em>
</p>
...
<p align="center">
 <img src="Images/주요 품종 색상 특징.PNG" style="width:600px;"/>
</p>
 <p align="center">     
  <em>그림 7:  주요접수 품종, 색상 및 특징 </em>
</p>
...
<p align="center">
 ...
 <p align="center">     
  <em>그림 9:  나이와 체중 관계 </em>
   ...
   보다시피 접수 중 주요 2022년생 동물이다. 그리고 사용자마다 욕구가 달라서 이 기능을 만들었다. 어떤 사용자가 젊고 작은 동물을 좋아하지만 좀 큰 동물을 좋아하는 사용자도 있다. 그래서 사용자가 원하는 나이와 체종을 클릭하면 정보가 나온다. 
<h4 align="left"> 4.7. 발견 도시별 접수 품종별 보호상태 히트맵 </h4>
   
<p align="center">  
 <img src="Images/발견도시별 품종별 보호상태.PNG" style="width:550px;"/>
</p>
   
 <p align="center">     
  <em>그림 10: 발견 도시별 접수 품종별 보호상태 히트맵 </em>
</p>
 전체적으로 보면 위와 같이 동일 결과는 모든 도시에서 "개"가 가장 많이 발견되었다. 그 중에 "경기도"에서 제일 높게 나타나며 뒤로 "경남"과 "전남" 등을 밝아지는 색상대로 수량이 적이진다. 주로 "보호중"상태이다.
...
<p align="center">
 ...
 히트맵을 통해 전국에 큰 도시에서 “보호중” 상태 유기 둥물을 제일 많이 차지하고 있다. 색상이 밝을수록 건수가 적다. "종료" 상태도 많으나 "안락사" 및 "자연사"원인으로 나타난다. 그래서 유기동물을 빨리 입양하고 좋은 주인을 만날 수 있도록 대안을 만들어야 한다.  
...
<h4 align="left"> 4.9. 전국동물보호센터 맵 </h4>
 ...
 <p align="center">     
  <em>그림 12: 전국동물보호센터 정보 조회 및 맵 </em>
...
* 위에 분석했던 데이터를 살펴보면 여러 원인으로 유기동물의 수량이 급격히 증가하고 있다. 현제 유기동물의 문제들은 한국의 사회 문제에 많은 주의를 받고 있습니다. 유기동물 보호 문제가 중요하고 긴급한 문제를 인식하여 우리 팀은 유기동물을 위한 한 웹사이트를 디자인했다. </br>
...
웹사이트의 메뉴에 홈, 동물입양, 서비스 센터, 쇼핑, 글리닉, 지도 순으로 있다. 그리고 웹사이트의 로고는 "Petadoption"이다. 또한 홈페이지의 인터페이스에 동물 서비스 센터, 유기동물 비디오와 뉴스에 대하여 내용을 디자인한다. 이 홈페이즈에서 고객들은  총괄적인 웹사이트을 보일 수 있다.
...
'동물 서비스 센터'는 홈페이지에 포함한다. 이 바는 동물 서비스들을 소개한다.
...
이 바는 유기동물을 알아보고 싶다면 유기동물에 대한 뉴스를 볼 수 있다
...
<p align = "center">
 <em>그림: 유기동물 비디오 바의 코드 및 인터페이스 </em>
  ...
  이 바는 유기동물을 알아보고 싶다면 유기동물을 대한 영상을 볼 수 있다.  
...
<p align = "center">
 <em>그림: 동물정보 페이지의 코드 및 인터페이스. 동물입양 페이지이다 </em>
</p>
  동물입양 페이지에는 '동물정보'와 '동물입양하기'가 있다. 동물정보 페이지에는 유기동물을 리스트를 볼 수 있다. 동물정보를 더 자세하게 보고 싶다면 '자세히 보기'에 눌러서 각 동물정보를 자세하게 보일 수 있다. 
...
<p align="center">
 <img src="Website/Picture13.png" style="width:800px;"/>
  ...
  <p align = "center">
 <em>그림: 동물입양하기 페이지의 코드 및 인터페이스. 동물입양 페이지이다. </em>
</p>
  이 페이지는 동물을 입양하는 이유를 전달한 것이다. 앞으로 우리는 동물을 입양하고 싶은 사람들은 개인 정보를 작성하며 우리는 고객의 정보를 관리할 수 있는 페이지를 디자인하고 싶다.  
